...
public class LoginStepDefinition {
	...
	public static void launchbrowser(String browsername) {
		...
		case "chrome":
			...
			//extentObject.logTestInfo("Browser instance is created");
	...
	public static void gotourl(String url) throws InterruptedException {
	   ...
	   // extentObject.logTestInfo(url +" was entered");
	}
	...
	public static void closeBrowser() {
		...
		//extentObject.logTestInfo("Browser instance closed");
		driver=null;
	}				
...
@AfterAll
public static void after_all_Scenario() {
