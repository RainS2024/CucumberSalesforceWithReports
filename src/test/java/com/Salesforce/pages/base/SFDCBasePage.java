...
public class SFDCBasePage {
	...
	public static ExtentReportsUtility extentObject = ExtentReportsUtility.getInstance();
	...
	public static void enterText(WebElement ele, String data, String objectName) {
		if (ele.isDisplayed()) {
			...
			//extentObject.logTestInfo("User data is entered in " + objectName + " textbox");
		} else {
			SFDCBasePagelog.info(objectName + " element is not displayed");
			//extentObject.logTestInfo(objectName + "element is not displayed");
		;
		}
	}
	...
	public static void clickElement(WebElement ele, String objectName) {
		if (ele.isEnabled()) {
			...
			//extentObject.logTestInfo(objectName + "button is clicked");
	...
	public static String getTextFromElement(WebElement ele, String objectName) {
		...
		//extentObject.logTestInfo("Text is extracted from "+objectName);
	...
	public static void getTitle(String expected) {
		if(driver.getTitle().contains(expected)) {
			...
			//extentObject.logTestInfo(driver.getTitle() + " is displayed");
		}
		else {
	...
	//extentObject.logTestInfo("Waited for " + object +  " visibility");
	}
